...
function Projects() {
  return (
    <section id="Proyectos" className="max-w-[1320px] z-40 sm:mx-auto w-full mt-24">
      ...
      <article className="content-center mb-8 ga gap-y-8 p-x-4 projects-grid">
        <ProjectCard
        title="Omnigeo"
        description="Aplicación web para estudiar y practicar geografía mundial. Aprende países, capitales y ubicaciones a través de un modo de estudio interactivo y un sistema de quiz desafiante. Cuenta con historial de sesiones y AI Coach."
        tags={ProyectoOmnigeo}
        previewLink="https://omni-geo.vercel.app"
        codeLink="https://github.com/Uli3000/Omnigeo"
        videoName="omnigeo"
        />
        <ProjectCard
          title="Pokedex"
          description="Proyecto que consume la PokeAPI y permite realizar búsquedas fáciles y controladas de la información de los Pokémon. Cuenta con scroll infinito, uso de Local Storage y de la Context API de React."
          tags={ProyectoPokedex}
          previewLink="https://pokeapi-uliversion.netlify.app/"
          codeLink="https://github.com/Uli3000/Pokedex-UliVersion"
          videoName="PokedexUVersion"
        />
        <ProjectCard
          title="Optimus Time"
        ...
        <ProjectCard
          title="Reticulas App"
          description="Proyecto escolar utilizando tecnologías básicas para manipular una base de datos en DB2, simulando ser un sistema escolar con carga de materias, planes de estudio y creación de retículas personalizadas."
          tags={ProyectoReticulasApp}
          previewLink="https://youtu.be/lfZa4flGt8Y"
          codeLink="https://github.com/Uli3000/AppReticulaTEC"
        ...
        <ProjectCard
          ...
          description="Minijuego de atrapar el color con un botón, donde cada vez que se reinicia el juego, se restablecen los estados, inspirado en el juego 'Bop It! Smash', utilizando los hooks de React y sus renderizados."
          tags={ProyectoAtrapaElColor}
        ...
        <ProjectCard
          ...
          description="Simulador del traductor de Google utilizando inteligencia artificial, con el modelo de Cohere, tipado en TypeScript y con uso de debounce."
          tags={ProyectoTraductor}
          previewLink="https://google-translator-simulator.netlify.app/"
          codeLink="https://github.com/Uli3000/GoogleTranslatorSimulator"
