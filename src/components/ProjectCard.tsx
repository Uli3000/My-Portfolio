...
function ProjectCard({
  ...
  return (
    <div className="proyectos-anima relative h-[28rem] w-72 lg:w-96 overflow-hidden rounded-xl border border-gray-800 p-[1px] backdrop-blur-3xl">
      ...
      <div className="inline-flex flex-col items-center justify-center w-full h-full px-3 py-1 text-sm font-medium rounded-xl bg-gray-950 text-gray-50 backdrop-blur-3xl">
        ...
        <div className="relative px-5 py-3 mt-[48%]">
          ...
          <p className="mb-3 font-[Onest] text-gray-400 text-[14.5px] text-pretty">
            {description}
          </p>
