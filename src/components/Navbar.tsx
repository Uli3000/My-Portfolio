...
const Navbar = () => {
    ...
    return (
            <div className="font-semibold z-50 max-w-[1320px] h-[65px] flex flex-row items-center justify-between md:mr-20 fixed top-0 left-1/2 -translate-x-1/2 lg:mt-0 mt-2">
                <div className={`flex items-center justify-between gap-x-4 w-full h-auto ${navStyle ? 'bg-[#0300145e] backdrop-blur' : 'border border-[rgba(112,66,248,0.38)] bg-transparent'} mr-[15px] px-[20px] py-[10px] rounded-full text-gray-200 `}>
                    ...
                    <a href="#Experiencia" className="cursor-pointer nav-item">
                        Experiencia
                    </a>
