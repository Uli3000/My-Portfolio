      ...
      <div className='flex flex-col justify-center w-full h-full gap-5 m-auto text-start'>
        ...
        >
          <p className='flex flex-col justify-center gap-y-3 text-wrap'>
            ...
            {windowWidth < breakpoint && (
              <span className='text-4xl font-medium'>Desarrollador Web</span>
            )}
          </p>
        </motion.div>
        ...
        >
          El universo ofrece tantas posibilidades como la programación y yo
          estoy en busca de todas ellas.
        </motion.p>
        <motion.div
        ...
        >
          ...
          <nav className='flex flex-row flex-wrap gap-4'>
            ...
            <a
              ...
              target='_blank'
              className='inline-flex items-center justify-center gap-2 px-4 py-1 text-gray-800 transition bg-gray-100 border border-gray-300 rounded-full dark:bg-gray-900 dark:border-gray-600 dark:text-white text-md hover:bg-gray-950 hover:border-gray-700 group max-w-fit hover:text-white focus:outline-none focus-visible:outline-none'
            >
            ...
            <a
              ...
              target='_blank'
              className='inline-flex items-center justify-center gap-2 px-4 py-1 text-white transition border border-gray-600 rounded-full dark:bg-gray-900 text-md hover:bg-gray-950 hover:border-gray-700 group max-w-fit hover:text-white focus:outline-none focus-visible:outline-none'
            >
              <Github /> GitHub
            </a>{' '}
          </nav>
